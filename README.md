...
```Check server.js for examples of usernames, then use Postman to send a get test using "x-username-and-password" and a string with the following format: "user=user@somewhere.com&pass=password"```
